            ...
            <form action="?btn_delete_all" method="post" class="table-responsive">
                ...
                <table width="100%" class="table table-hover table-bordered text-center">
                    ...
                    foreach ($items as $item) {
                        ...
                        ?>
                        <tr>
                            <td><input type="checkbox" class="form-check-input" name="ma_bl[]" value="<?= $ma_bl ?>">
                            </td>
                            ...
                            <td class="text-end">
                                <a href="index.php?btn_delete&ma_bl=<?= $ma_bl ?>&ma_hh=<?= $ma_hh ?>"
                                   class="btn btn-outline-success btn-rounded bi bi-trash3-fill "
                ...
                <i class="ml-5">hàng hóa: <b><?= $items[0]['ten_hh'] ?></b></i>
